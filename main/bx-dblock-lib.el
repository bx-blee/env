...
(defun bx:dblock:all-defaults-set ()
  ...
  (load-file "~/lisp/dblock/dblock-lcnt-latex-front.el")
  (load-file "~/lisp/dblock/dblock-lcnt-latex-body.el")
  (load-file "~/lisp/dblock/dblock-lcnt-latex.el")
  (load-file "~/lisp/dblock/dblock-lcnt-latex-pres.el")
  (load-file "~/lisp/dblock/dblock-lcnt-latex-panel.el")
  (load-file "~/lisp/dblock/dblock-lcnt-pres-panel.el")    
  (load-file "~/lisp/dblock/dblock-lcnt-bash.el")
  (load-file "~/lisp/dblock/dblock-iim-bash.el")
  (load-file "~/lisp/dblock/dblock-iim-python.el")
  (load-file "~/lisp/iim-python.el")    
  ;;(load-file "~/lisp/dblock/dblock-bash.el")
  (load-file "~/lisp/dblock/dblock-ploneProc-bash.el")
  (load-file "~/lisp/dblock/dblock-org-general.el")
  (load-file "~/lisp/dblock/dblock-org-bnsm.el")
  (load-file "~/lisp/dblock/dblock-global.el")
  (load-file "~/lisp/dblock/dblock-global-run-results.el")
  (load-file "~/lisp/dblock/dblock-emacs-lisp.el")
  (load-file "~/lisp/dblock/dblock-org-iims.el")
  (load-file "~/lisp/dblock/dblock-iims-panel.el") 

;;; -*- Mode: Emacs-Lisp; -*-
;; Start Example: (replace-string "moduleName" "boot-common")  (replace-string "moduleTag:" "boot-common:")

(lambda () "
*  [[elisp:(org-cycle)][| ]]  *Short Desription*  :: Library (boot-common:), for handelling File_Var [[elisp:(org-cycle)][| ]]
* 
")

...
(defun bcg:font:iosevka/select ()
  ""
  (interactive)
  (blee:ann|this-func (compile-time-function-name))    

  ;;(defvar blee:font:default (font-spec :family "Iosevka" :size 24))
  (setq blee:font:default (font-spec :family "Iosevka" :size 18))
  (set-face-attribute 'default nil :font blee:font:default)
  )
